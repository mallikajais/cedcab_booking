...
<body style="margin-right:0px;overflow-x: hidden">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="signup.php"><i class="fa fa-user-plus" aria-hidden="true" style="color:white;"></i><b>Signup</b><span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="login.php"><i class="fa fa-sign-in" aria-hidden="true" style="color:white;"></i><b>Login</b></a>
                    </li>
                    <li class="nav-item">
                            ...
                            <div class="modal-dialog ">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-info" data-dismiss="modal" onClick="window.open('login.php')" >  Book Cab  </button>
    ...
    function luggage(){
        if (document.getElementById("cabtype").value=="CedMicro"){
            ...
            alert("In cedmicro luggage is not allowed");
